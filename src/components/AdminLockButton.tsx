  ...
  return (
    <>
      <button
        ...
        className="group fixed left-4 top-4 z-50 grid h-11 w-11 place-items-center rounded-xl border border-white/10 bg-black/50 backdrop-blur-xl transition-all duration-300 hover:border-[color:var(--neon)]/60 hover:bg-black/70 hover:shadow-[0_0_30px_-2px_oklch(0.82_0.2_165_/_0.7)] hover:scale-105"
      >
