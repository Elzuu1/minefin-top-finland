...
export function FounderCard({ username = "Elzuu1" }: { username?: string }) {
  return (
    <section className="relative mx-auto w-full max-w-4xl overflow-hidden px-4 py-6 sm:overflow-visible sm:py-16">
      {/* Ambient multi-layer halo — stronger breathing pulse */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-1/2 h-[110%] w-[110%] -translate-x-1/2 -translate-y-1/2 rounded-[40%] bg-[color:var(--neon)]/30 blur-[60px] sm:h-[150%] sm:w-[150%] sm:bg-[color:var(--neon)]/45 sm:blur-[180px] animate-strong-pulse" />
        <div className="absolute left-1/2 top-1/2 h-[80%] w-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[color:var(--neon-2)]/25 blur-[50px] sm:h-[110%] sm:w-[110%] sm:bg-[color:var(--neon-2)]/35 sm:blur-[150px] animate-strong-pulse" style={{ animationDelay: '0.6s' }} />
      </div>

      {/* Rotating conic border wrapper */}
      <div className="group relative rounded-[22px] p-[2px] sm:rounded-[28px] sm:p-[3px] [background:conic-gradient(from_0deg,transparent_0deg,oklch(0.82_0.2_165)_60deg,oklch(0.7_0.22_200)_120deg,transparent_200deg,transparent_360deg)] overflow-hidden">
        ...
        <div className="relative cursor-pointer overflow-hidden rounded-[20px] border border-[color:var(--neon)]/70 bg-gradient-to-br from-black/90 via-black/75 to-[color:var(--neon)]/25 p-3 backdrop-blur-xl shadow-[0_0_60px_-5px_oklch(0.82_0.2_165_/_0.8),inset_0_0_30px_-10px_oklch(0.82_0.2_165_/_0.5)] transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-3 hover:scale-[1.06] hover:shadow-[0_0_260px_0px_oklch(0.82_0.2_165),0_0_160px_-10px_oklch(0.7_0.22_200_/_0.95),inset_0_0_100px_-10px_oklch(0.82_0.2_165_/_0.85)] active:-translate-y-1 active:scale-[1.03] sm:rounded-[26px] sm:p-10 sm:shadow-[0_0_140px_-5px_oklch(0.82_0.2_165_/_0.98),0_0_80px_-15px_oklch(0.7_0.22_200_/_0.8),inset_0_0_70px_-10px_oklch(0.82_0.2_165_/_0.6)] animate-float-glow">
          ...
          <div className="relative flex flex-col items-center gap-3 text-center sm:gap-5">
            <div className="flex items-center gap-2">
              <span className="h-1.5 w-1.5 rounded-full bg-[color:var(--neon)] shadow-[0_0_12px_oklch(0.82_0.2_165)] animate-pulse sm:h-2 sm:w-2" />
              <p className="font-mono text-[9px] font-bold uppercase tracking-[0.3em] text-[color:var(--neon)] text-glow-neon sm:text-xs sm:tracking-[0.4em]">
                #1 · FinlandSMP
              </p>
              <span className="h-1.5 w-1.5 rounded-full bg-[color:var(--neon)] shadow-[0_0_12px_oklch(0.82_0.2_165)] animate-pulse sm:h-2 sm:w-2" />
            </div>
            ...
            <div className="relative">
              ...
              <img
                ...
                className="relative h-32 w-auto object-contain [image-rendering:pixelated] drop-shadow-[0_0_20px_oklch(0.82_0.2_165)] transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:scale-[1.18] group-hover:drop-shadow-[0_0_90px_oklch(0.82_0.2_165)] group-active:scale-105 sm:h-96 sm:drop-shadow-[0_0_30px_oklch(0.82_0.2_165)]"
                loading="eager"
              />
            </div>

            <div className="space-y-2">
              <h2 className="font-display text-2xl font-black tracking-tight transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:scale-110 sm:text-6xl">
                <span className="bg-gradient-to-br from-white via-white to-[color:var(--neon)] bg-clip-text text-transparent text-glow-neon">
                  {username}
                </span>
              </h2>
              <div className="inline-flex items-center gap-1.5 rounded-full border border-[color:var(--neon)]/60 bg-black/50 px-2.5 py-1 shadow-[0_0_24px_-4px_oklch(0.82_0.2_165_/_0.8)] backdrop-blur sm:gap-2 sm:px-3">
                <span className="text-yellow-400 drop-shadow-[0_0_6px_rgba(250,204,21,0.9)] text-xs sm:text-sm">👑</span>
                <p className="font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-white sm:text-sm sm:tracking-[0.25em]">
